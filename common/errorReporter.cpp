...
//{ "incdt_incdt_recurring_incdt_id_fkey",      Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  ...
  { "incdtcat_tasktmpl_id_fkey",                Delete,  0, QT_TRANSLATE_NOOP("errorReporter", "Cannot delete the Task Template as it is linked to an Incident Category.") },
...
//{ "ophead_ophead_priority_id_fkey",           Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  ...
  { "optype_tasktmpl_id_fkey",                  Delete,  0, QT_TRANSLATE_NOOP("errorReporter", "Cannot delete the Task Template as it is linked to an Opportunity Type.") },
...
//{ "prjtask_prjtask_status_check",             Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "") },
  { "prjtype_tasktmpl_id_fkey",                 Delete,  0, QT_TRANSLATE_NOOP("errorReporter", "Cannot delete the Task Template as it is linked to a Project Type.") },
...
//{ "status_status_type_key",                   Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "A XXX already exists with this XXX.") },
  ...
  { "task_task_name_check",                     Upsert,  0, QT_TRANSLATE_NOOP("errorReporter", "You must enter both a Task Number and Task Name.") },
